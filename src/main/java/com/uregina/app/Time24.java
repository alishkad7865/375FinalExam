...
public class Time24 {
	 ...
	 * @return An equavalent Time24 object a null for invalid input parameters No
	 ...
	 * @return the value of (t1-t2) in minutes it may be a negative value
	 */
